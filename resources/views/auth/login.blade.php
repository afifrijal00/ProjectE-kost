    ...
    class="h-40 w-auto mx-auto mb-10 drop-shadow-2xl">
            ...
            <div class="mt-12 space-y-4">
                <div class="flex items-center space-x-3 text-sm text-gray-300">
                    ...
                    <span>Aman, praktis, dan efisien</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div class="w-full max-w-md bg-white rounded-2xl shadow-md p-8">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-[#012619]">Masuk</h1>
                <p class="text-gray-500 mt-2">Masukkan email dan kata sandi Anda untuk melanjutkan.</p>
            </div>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <a href="{{ route('password.request') }}" class="text-xs text-[#400000] hover:text-[#035949] font-medium transition">Lupa kata sandi?</a>
                    </div>
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Belum punya akun? <a href="{{ route('register') }}" class="text-[#188C4A] hover:text-[#035949] font-medium transition">Daftar</a>
            </p>
