...
@section('title', 'Upload Bukti Pembayaran - e-Kost')
...
@section('content')
    <div class="max-w-md mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            ...
            <p class="text-sm text-gray-500 mb-6">Rp {{ number_format($payment->amount, 0, ',', '.') }} &middot;
            ...
            <form action="{{ route('payments.store-proof', $payment->id) }}" method="POST" enctype="multipart/form-data"
                class="space-y-5">
                @csrf
