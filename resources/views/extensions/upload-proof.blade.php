...
@section('title', 'Upload Bukti Perpanjangan - e-Kost')
...
@section('content')
    <div class="max-w-md mx-auto space-y-6">
        ...
        <div class="mb-2">
            <a href="{{ route('extensions.qris', $extension->id) }}"
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
            <h3 class="font-bold text-[#400000] text-lg mb-1">Konfirmasi Pembayaran</h3>
            <p class="text-sm text-gray-500 mb-6">Rp {{ number_format($extension->amount, 0, ',', '.') }} &middot;
                Perpanjangan {{ $extension->duration }} bulan</p>
            ...
            <form action="{{ route('extensions.store-proof', $extension->id) }}" method="POST" enctype="multipart/form-data"
                class="space-y-5">
                @csrf
