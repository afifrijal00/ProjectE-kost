...
@section('title', 'Pembayaran Perpanjangan - e-Kost')
@section('page-title', 'Pembayaran Perpanjangan')
...
@section('content')
    <div class="max-w-md mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center">
            ...
            <p class="text-3xl font-bold text-[#400000]">Rp {{ number_format($extension->amount, 0, ',', '.') }}</p>
            <p class="text-xs text-gray-400 mt-1">
                Perpanjangan {{ $extension->duration }} bulan &middot; Kamar
        ...
        <a href="{{ route('extensions.upload-proof', $extension->id) }}"
