<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    ? 'text-white bg-[#035949] border-[#30BF62]'
    : 'text-gray-300 border-transparent hover:bg-[#035949] hover:text-white hover:border-gray-500' }}">
                <svg class="w-5 h-5 group-hover:text-[#30BF62] transition duration-200" fill="none"
    ...
    : 'text-gray-300 border-transparent hover:bg-[#035949] hover:text-white hover:border-gray-500' }}">
                ...
                <span
                    class="ml-auto inline-block py-0.5 px-2 bg-red-500 text-white text-xs rounded-full font-bold">2</span>
            </a>
...
<div x-show="sidebarOpen" x-transition:enter="transition-opacity ease-linear duration-300"
    ...
    x-transition:leave-end="opacity-0" class="fixed inset-0 z-30 bg-gray-900 bg-opacity-50 lg:hidden"
