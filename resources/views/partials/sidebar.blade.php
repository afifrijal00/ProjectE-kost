<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="absolute z-40 flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-[#400000] border-r border-[#035949] transition-transform duration-300 ease-in-out lg:static lg:translate-x-0">
    ...
    <div class="flex flex-col flex-1 mt-6">
        ...
        <a href="{{ route('dashboard.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
    ...
    : 'text-gray-300 border-transparent hover:bg-[#6d0000] hover:text-white hover:border-[#ad3333]' }}">
            ...
            <!-- Rooms Item (Inactive) -->
            <a href="{{ route('dashboard.rooms') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
               {{ request()->routeIs('dashboard.rooms*')
   ? 'text-white bg-[#6d0000] border-[#ad3333]'
    : 'text-gray-300 border-transparent hover:bg-[#6d0000] hover:text-white hover:border-[#ad3333]' }}">
                <svg class="w-5 h-5 group-hover:text-[#f5f5f5] transition duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Tenants -->
            <a href="{{ route('tenants.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
   ...
   ? 'text-white bg-[#6d0000] border-[#ad3333]'
    : 'text-gray-300 border-transparent hover:bg-[#6d0000] hover:text-white hover:border-[#ad3333]' }}">
            ...
            <a href="{{ route('admin.bookings.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
  ...
  ? 'text-white bg-[#6d0000] border-[#ad3333]'
    : 'text-gray-300 border-transparent hover:bg-[#6d0000] hover:text-white hover:border-[#ad3333]' }}">
            ...
            <!-- Payments -->
            <a href="{{ route('admin.payments.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
   ...
   ? 'text-white bg-[#6d0000] border-[#ad3333]'
    : 'text-gray-300 border-transparent hover:bg-[#6d0000] hover:text-white hover:border-[#ad3333]' }}">
            ...
            <!-- Complaints -->
        <a href="{{ route('complaints.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
...
<span id="complaint-badge"
    ...
    {{ $unreadComplaints > 0 ? $unreadComplaints : '' }}
            ...
            <!-- Reminders -->
            <a href="{{ route('reminders.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
    ...
    : 'text-gray-300 border-transparent hover:bg-[#6d0000] hover:text-white hover:border-[#ad3333]' }}">
            ...
            <!-- Reports -->
            <a href="{{ route('reports.index') }}" class="group flex items-center px-4 py-3 rounded-xl border-l-4 transition duration-200
